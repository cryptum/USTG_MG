...
namespace USTG_MG.AppWin32.Cadastros.Religioes
{
    public partial class List : Form
    {
        ...
        {
            var lista = _repository.Religioes.ObterTodos();            
        ...
        private void ExecutaDel(int index)
        {
            try
            {
                var obj = gridList.Rows[index].DataBoundItem as Religiao;
                ...
                {
                    var religiao = _repository.Religioes.ObterNovoOuPor(obj.Id);
                    _repository.Religioes.Excluir(religiao);
        ...
        {
            var frm = new Religioes.Edit(_repository, id);
            frm.ShowDialog();
            CarregaGrid();
        }
